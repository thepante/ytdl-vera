#!/bin/bash
sudo cp ./extractor/vera.py "~/.local/lib/python2.7/site-packages/youtube_dl/extractor/vera.py" && 
...
echo 'from .vera import VeraIE' >> ~/.local/lib/python2.7/site-packages/youtube_dl/extractor/extractors.py &&
